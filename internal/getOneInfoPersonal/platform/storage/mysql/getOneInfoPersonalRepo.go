...
func (g *GetOneInfoPersonalRepository) GetOneInfoPersonalRepo(ctx context.Context, id int) (getOneInfoPersonal.GetOneInfoPersonalResponse, error) {
	...
	if err := rowsSql.Scan(&respDB.Id, &respDB.FirstName, &respDB.SecondName, &respDB.LastName, &respDB.SecondLastName, &respDB.Sex, &respDB.DateOfBirth, &respDB.TypeDocument, &respDB.DocumentNumber, &respDB.User, &respDB.TypeUser, &respDB.DateCreationAccount, &respDB.StateName); err != nil {
